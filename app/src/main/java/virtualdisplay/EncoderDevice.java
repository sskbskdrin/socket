...
import cn.sskbskdrin.floatview.StreamUtility;
import p000a.C0001c;
import p000a.C0006d;
import p000a.C0008g;
import p000a.C0011h;
...
public abstract class EncoderDevice {
	...
	public Surface createDisplaySurface() {
		...
		try {
			...
			C0011h c0011h = new C0011h("MediaSettings");
			C0001c encoder = c0011h.m10b("VideoEncoderCap");
			final ArrayList<VideoEncoderCap> encoders = new ArrayList();
			encoder.m4a((C0006d) new C0006d() {
				public void end() {
				}
			...
			C0008g.m15a(new StringReader(xml), c0011h.m18b());
			if (encoders.size() != 1) {
